        ...
        <section id="register" className="col-md-6 offset-md-3">
          ...
          <form onSubmit={this.handleSubmit}>
            <div className="form-group">
              ...
              <input type="username" id="username" name="username" value={this.state.username} onChange={this.handleChange} className="form-control form-control-lg" placeholder="Name"/>
            </div>
            <div className="form-group">
